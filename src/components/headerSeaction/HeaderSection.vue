<template>
  <div class="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
    <img src="https://images.unsplash.com/photo-1565084888279-aca607ecce0c?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" class="absolute inset-0 -z-10 h-full w-full object-cover object-right md:object-center" />
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-2xl lg:mx-0">
        <h2 class="text-4xl  font-bold tracking-tight text-gray-900 bg-blue-50 -rotate-3 sm:text-6xl">Одеваем по карману</h2>
        <p class="mt-6 text-lg leading-8 text-gray-900">Тысячи стоковых и не только вещей со всего мира ...</p>
      </div>
...
const stats = [
  ...
  { name: 'Джинсы', value: '300+' },
  { name: 'Майки', value: '500+' },
